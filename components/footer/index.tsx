    ...
    <footer className="w-full border-t border-gray-200 bg-white py-8 dark:border-gray-800 dark:bg-gray-950">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">About AI Beauty</h3>
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              Create stunning AI-generated beauty images using cutting-edge DALL-E technology.
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <a href="/gallery" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100">
                  Gallery
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              <a
                href="https://twitter.com/hroyhonghong"
                target="_blank"
              ...
              <a
                href="https://github.com/hroyhong/ai-beauty"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
              >
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 dark:border-gray-800">
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            © {new Date().getFullYear()} AI Beauty. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
